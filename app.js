...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "nav-pricing": "Pricing",
      "nav-compliance": "Process",
      "nav-faq": "Q&A",
      "btn-get-started": "Get Proposal",
      "hero-badge-text": "Websites, software and automation for growing businesses",
      "hero-title-part1": "Websites and software",
      "hero-title-part2": "that get enquiries and automate work.",
      "hero-desc-text": "TheoMedia designs and builds conversion-focused websites, CRM tools, POS systems, dashboards and automations for businesses that want more enquiries and less manual work.",
      "hero-cta-primary": "See Example Builds",
      "hero-cta-secondary": "Get a Free Proposal",
      "marquee-title": "PRACTICAL BUILD CAPABILITIES FOR MODERN SERVICE AND RETAIL BUSINESSES",
      "services-micro": "WHAT WE BUILD",
      "services-title": "Commercial websites and software that do the job",
      "services-desc": "Strategy, interface design, development, launch support and handover for teams that need a polished public site and dependable internal tools.",
      "serv-web-title": "Websites & E-Commerce",
      "serv-web-sub": "Positioning, design, SEO and conversion",
      "serv-web-desc": "Responsive websites built to explain your offer quickly, earn trust, capture enquiries and give Google a clean technical foundation.",
      "serv-best": "BEST FOR",
      "serv-web-best": "Service businesses, consultants, local companies, ecommerce brands and B2B teams that need better enquiries.",
      "serv-web-feat1": "Fully responsive on phones & tablets",
      "serv-web-feat2": "Clear service pages and calls to action",
      "serv-web-feat3": "Technical SEO, schema and analytics setup",
      "serv-web-feat4": "Fast loading and simple content handover",
      "serv-popular": "RECOMMENDED",
      "serv-app-title": "Web Applications (ERP/CRM)",
      "serv-app-sub": "Private tools for real workflows",
      "serv-app-desc": "Browser-based systems for enquiries, customers, stock, staff, invoicing and reporting when off-the-shelf tools no longer fit.",
      "serv-app-best": "Replacing spreadsheets, scattered notes, manual follow-ups and disconnected invoicing or stock records.",
      ...
      "serv-mob-sub": "Mobile experiences tied to your system",
      "serv-mob-desc": "Android apps and mobile-first portals for customers, field teams, loyalty flows and internal tools that need to work away from a desk.",
      ...
      "pos-item-support": "Launch Support Package",
      ...
      "templates-micro": "PORTFOLIO DIRECTIONS",
      "templates-title": "Visual styles with a business reason",
      "templates-desc": "Each project direction starts with the commercial outcome: better trust, clearer offers, faster workflows and fewer dropped enquiries.",
      "temp-badge-award": "WEBSITE CONCEPT",
      "temp-badge-concept": "SOFTWARE CONCEPT",
      "temp-banana-desc": "A polished homepage and service-page system for businesses that need to look established, explain value fast and turn visitors into booked calls.",
      "temp-zurich-desc": "A private CRM, POS or reporting dashboard that gives owners one place to manage leads, orders, stock, invoices and team activity.",
      "temp-btn-demo": "Request a similar build",
      "map-micro": "WHY CLIENTS CAN TRUST THE BUILD",
      "map-title": "A clear process, direct contact and clean handover",
      "map-desc": "No mystery platform, no vague ownership terms and no inflated compliance theatre. You know what is being built, where it runs and what you receive at launch.",
      "map-regulatory": "OUTPUT",
      "map-currency": "CONTACT",
      "map-support": "BEST FOR",
      "map-desc-london": "We define the audience, offer, workflows, data, integrations and success measures before design starts.",
      "pricing-micro": "STARTING POINTS",
      "pricing-title": "Clear project ranges before we talk",
      "pricing-desc": "Use these starting prices to frame scope. Final quotes depend on content, integrations, pages, data models and support needs.",
      ...
      "faq-micro": "FAQ",
      "faq-title": "Straight answers before you enquire",
      "faq-desc": "Ownership, delivery, integrations and support explained in plain language.",
      "faq-q1": "Who owns the custom code once the project is finished?",
      "faq-a1": "You do, once the final invoice is paid. We hand over the agreed source code, repository access, documentation and credentials needed to operate the project. Any third-party services remain subject to their own terms.",
      "faq-q2": "How does the integrated WhatsApp dispatch engine operate?",
      "faq-a2": "We connect your workflow to approved messaging or email services where suitable. For example, a POS or CRM action can generate a receipt, invoice or follow-up message and send it through the agreed channel.",
      "faq-q3": "Can you link my web applications to customized domains?",
      "faq-a3": "Yes. We can connect websites and web apps to your chosen domain, configure SSL and advise on DNS records. Hosting and domain fees are separate unless included in your proposal.",
      "faq-q4": "What compliance measures do you build in for European trade?",
      "faq-a4": "We design with privacy in mind: clear forms, minimal data collection, access control, cookie notices where needed and documented data flows. Legal compliance still depends on your business policies and should be reviewed by your advisor.",
      "contact-micro": "PROJECT HUB",
      "contact-title": "Tell us what needs to work better",
      "contact-desc": "Send the outcome you want, what is broken today and any tools you already use. We will reply with a practical next step, not a generic sales script.",
      "contact-email-title": "Direct enquiries",
      "contact-hq-title": "Fast contact",
      "form-label-name": "Full Name / Organisation",
      "form-label-email": "Email Address",
      "form-label-solution": "Requested Project Scope",
      ...
      "form-success-text": "Thank you. Your project details are ready to send through WhatsApp so we can reply with a practical next step.",
      "foot-brand-desc": "Designing and building websites, dashboards, CRM tools, POS workflows and mobile apps for businesses that need clearer digital systems.",
      "foot-solutions": "Solutions",
      "foot-sol-web": "Website Design",
      "foot-sol-app": "CRM & Web Apps",
      "foot-sol-wa": "WhatsApp API Integrations",
      "foot-sol-mob": "Mobile App Development",
      "foot-compliance": "Trust",
      "foot-comp-gdpr": "Privacy Policy",
      "foot-comp-swiss": "Terms of Service",
      "foot-comp-uk": "Project Process",
      "foot-comp-vat": "Contact TheoMedia",
      "foot-reach": "Contact",
    ...
    de: {
      ...
      "services-desc": "Wir planen, gestalten und entwickeln Websites und interne Tools mit klarer Struktur, schneller Umsetzung und sauberer Übergabe.",
      "serv-web-title": "Websites & E-Commerce",
      ...
      "serv-best": "IDEAL FÜR",
      "serv-web-best": "Dienstleister, lokale Unternehmen, E-Commerce-Marken und B2B-Teams, die bessere Anfragen benötigen.",
      ...
      "serv-app-desc": "Private Browser-Tools für Kunden, Lager, Rechnungen, Teams und Berichte, wenn Standardsoftware nicht mehr passt.",
      ...
      "pos-item-support": "Launch-Support-Paket",
      ...
      "temp-zurich-desc": "Ein privates CRM-, POS- oder Reporting-Dashboard, das Leads, Bestellungen, Lager, Rechnungen und Teamarbeit an einem Ort bündelt.",
      ...
      "map-desc-london": "Wir definieren Zielgruppe, Angebot, Workflows, Daten, Integrationen und Erfolgskriterien, bevor das Design beginnt.",
      ...
      "foot-compliance": "Vertrauen",
      "foot-comp-gdpr": "DSGVO Datentrennung",
      "foot-comp-swiss": "Servicebedingungen",
    ...
    fr: {
      ...
      "serv-app-desc": "Outils privés dans le navigateur pour clients, stock, factures, équipes et rapports lorsque les logiciels standards ne suffisent plus.",
      ...
      "pos-item-support": "Support de lancement",
      ...
      "foot-compliance": "Confiance",
      "foot-comp-gdpr": "Cloisonnement RGPD",
      "foot-comp-swiss": "Conditions de service",
    ...
    es: {
      ...
      "pos-item-support": "Soporte de lanzamiento",
      ...
      "map-support": "SOPORTE",
      "map-desc-london": "Definimos audiencia, oferta, flujos, datos, integraciones y medidas de éxito antes de diseñar.",
  ...
  const posItemNames = {
    ...
    support: {
      en: "Launch Support Package",
      de: "Launch-Support-Paket",
      fr: "Support de lancement",
      es: "Soporte de lanzamiento"
    }
  };
