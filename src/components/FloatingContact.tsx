...
const WHATSAPP_MESSAGE = `Hi ${site.brand}, I would like to discuss a website, app or business software project.`;
  ...
  return (
    <aside className={styles.dock} aria-label="Quick contact">
      ...
      <a
        ...
        title={`Chat with ${site.brand} on WhatsApp`}
      >
        <span className={styles.icon} aria-hidden="true">
          <WhatsAppIcon />
        </span>
