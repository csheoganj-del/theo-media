...
const features = [
  { title: 'Product Storytelling', description: 'Each product presented with editorial photography and compelling narrative.' },
  { title: 'Frictionless Checkout', description: 'One-tap Apple Pay, Google Pay and Stripe checkout on mobile and desktop.' },
  { title: 'Stripe & Shopify', description: 'Full payment and inventory integration with your preferred commerce platform.' },
  { title: 'Mobile Commerce', description: 'Cart, browsing and checkout designed for thumb-first mobile shopping.' },
  { title: 'Inventory Management', description: 'Real-time stock syncing, variant management and automated notifications.' },
  { title: 'Currency & Shipping', description: 'Multi-currency support and configurable shipping zones for international sales.' },
];
      ...
      <section className="bg-near-black text-bone pt-32 pb-20 md:pt-40 md:pb-28 px-5 md:px-8 lg:px-12">
        <div className="max-w-[1440px] mx-auto">
          ...
          <p className="text-[16px] md:text-[18px] text-bone/60 leading-relaxed max-w-[560px]">
            Premium shopping experiences built around product presentation and frictionless conversion.
          </p>
        </div>
      </section>
      ...
      <section className="bg-ivory py-20 md:py-28 px-5 md:px-8 lg:px-12">
        <div className="max-w-[1440px] mx-auto text-center">
          ...
          <p className="text-[16px] text-stone mb-8 max-w-[480px] mx-auto">
            From artisan brands to high-volume retail, we build stores that convert.
          </p>
          <Link
            href="/contact"
