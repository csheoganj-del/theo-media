...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/web-design-london`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/web-design-manchester`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${baseUrl}/web-design-birmingham`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
  ...
  const industryPages: MetadataRoute.Sitemap = [
    ...
    '/industries/salon-website-design',
    '/industries/garage-website-design',
    '/industries/barber-website-design',
  ].map((path) => ({
    url: `${baseUrl}${path}`,
    lastModified: now,
  ...
  const journalPages: MetadataRoute.Sitemap = [
    ...
    '/journal/wordpress-vs-custom-website',
    '/journal/how-to-choose-a-web-designer-uk',
    '/journal/does-a-restaurant-need-a-website',
    '/journal/website-seo-for-small-business-uk',
  ].map((path) => ({
    url: `${baseUrl}${path}`,
    lastModified: now,
    changeFrequency: 'monthly' as const,
