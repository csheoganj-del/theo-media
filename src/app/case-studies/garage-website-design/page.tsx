...
export default function GarageCaseStudy() {
  const demoUrl = "https://hartwell-motorworks.theomedia.co.uk";
      ...
      <section className="pt-32 md:pt-48 pb-16 md:pb-24 px-5 md:px-8 lg:px-12 max-w-[1440px] mx-auto">
        <FadeIn className="max-w-4xl">
          ...
          <div className="font-sans text-[17px] md:text-[20px] leading-relaxed text-stone max-w-2xl space-y-6 mb-12">
            ...
            <p>Hartwell Motorworks was designed and engineered by TheoMedia as a modern digital platform for an independent garage, MOT centre, and vehicle workshop, built directly around the real problems garage customers face when looking for automotive support online.</p>
          </div>
          ...
          <aside className="lg:w-[25%] hidden lg:block">
            <div className="sticky top-32">
              ...
              <nav className="flex flex-col gap-4">
                ...
                <a href="#what-we-would-add" className="text-[13px] font-sans text-stone hover:text-near-black transition-colors">Advanced Integrations &amp; Custom Features</a>
        ...
        <div className="max-w-[1440px] mx-auto text-center">
          <FadeIn>
            <h2 className="font-display text-[32px] md:text-[48px] mb-6">
              Explore the Hartwell Motorworks Website
            </h2>
            <p className="font-sans text-[16px] md:text-[18px] text-bone/70 max-w-2xl mx-auto mb-12">
              Hartwell Motorworks was designed and built by TheoMedia as a complete digital platform for an independent garage, MOT centre, and automotive workshop. 
            </p>
            ...
            <div className="max-w-2xl mx-auto border-t border-bone/10 pt-20 mb-20">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
                ...
                <a 
                  href="https://wa.me/353852258004?text=Hi%20TheoMedia,%20I%20have%20an%20automotive%20business%20similar%20to%20Hartwell%20Motorworks%20and%20would%20like%20to%20discuss%20a%20website%20project." 
                  target="_blank"
                  rel="noopener noreferrer"
